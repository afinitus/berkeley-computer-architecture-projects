...
class TestAdd(TestCase):
    ...
    def test_large_add(self):
        ...
        dp_mat3, nc_mat3 = rand_dp_nc_matrix(500, 500, seed=2)
        dp_mat4, nc_mat4 = rand_dp_nc_matrix(500, 500, seed=3)
        dp_mat5, nc_mat5 = rand_dp_nc_matrix(500, 500, seed=4)
        is_correct, speed_up = compute([dp_mat1, dp_mat2, dp_mat3, dp_mat4, dp_mat5], [nc_mat1, nc_mat2, nc_mat3, nc_mat4, nc_mat5], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    def test_small_abs(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(1000, 1000, seed=6)
